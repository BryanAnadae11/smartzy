...
def faq(request):
	return render(request, 'smartzyapp/faq.html')

def portfolio(request):
	return render(request, 'smartzyapp/portfolio.html')

def home(request):
	return render(request, 'smartzyapp/index.html')

def card(request):
	return render(request, 'smartzyapp/card.html')

def stats(request):
	return render(request, 'smartzyapp/stats.html')

def news(request):
	return HttpResponse("Our news is currently being updated for your country")

def legal(request):
	return render(request, 'smartzyapp/legal.html')

def affiliates(request):
	return render(request, 'smartzyapp/affiliates.html')

def oilandgas(request):
	return render(request, 'smartzyapp/oilandgas.html')

def plan(request):
	return render(request, 'smartzyapp/plan.html')

def otherpayment(request):
    return render(request, 'smartzyapp/otherpayment.html')


def about(request):
	return render(request, 'smartzyapp/about.html')


def career(request):
	return render(request, 'smartzyapp/career.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('smartzyapp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'smartzyapp/signin.html')


def privacy(request):
	return render(request, 'smartzyapp/portfolio2.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'smartzyapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('smartzyapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('smartzyapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
		...
		second_template= render_to_string('smartzyapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'smartzyapp/signup.html', context)
...
def dashboard(request):
	...
	return render(request, 'smartzyapp/dashboard.html', context)
...
def admindashboard(request):
	...
	return render(request, 'smartzyapp/adminpage.html', context)
...
def realestate(request):
	return render(request, 'smartzyapp/realestate.html')


def crypto(request):
	return render(request, 'smartzyapp/crypto.html')


def forex(request):
	return render(request, 'smartzyapp/forex.html')


def nft(request):
	return render(request, 'smartzyapp/nft.html')


def contact(request):
	return render(request, 'smartzyapp/contact.html')


def stocks(request):
	return render(request, 'smartzyapp/stocks.html')


def agriculture(request):
	return render(request, 'smartzyapp/agriculture.html')


def gold(request):
	return render(request, 'smartzyapp/gold.html')


def retirement(request):
	return render(request, 'smartzyapp/retirement.html')
...
def packageOptions(request):
	return render(request, 'smartzyapp/deposit.html')
...
def agriculturalDeposit(request):
	...
	context= {}
	return render(request, 'smartzyapp/agriculturalDeposit.html', context)
...
def stocksDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'smartzyapp/StocksDepositForm.html', context)
...
def cryptoDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'smartzyapp/cryptoDepositForm.html', context)
...
def oilandgasDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'smartzyapp/oilandgasDeposit.html')
...
def goldDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'smartzyapp/goldDeposit.html', context)
...
def forexDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'smartzyapp/forexDeposit.html', context)
...
def retirementDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'smartzyapp/retirementdepositForm.html', context)
...
def realestateDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'smartzyapp/realestateDepositForm.html', context)
...
def portfolioDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'smartzyapp/PortfolioDepositForm.html', context)
...
def deposit(request):
	if request.method=='GET':
		...
		if price_amount and pay_currency:
			...
			template= render_to_string('smartzyapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
...
def btc_deposit(request):
	...
	return render(request, 'smartzyapp/btc_deposit.html', context)
...
def usdt_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'smartzyapp/usdt_deposit.html', context)
...
def ltc_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'smartzyapp/ltc_deposit.html', context)
...
def doge_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'smartzyapp/doge_deposit.html', context)
...
def eth_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'smartzyapp/eth_deposit.html', context)
...
def trx_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'smartzyapp/trx_deposit.html', context)
...
def withdrawal(request):
	...
	context={}
	return render(request, 'smartzyapp/withdrawal2.html', context)
...
def history(request):
	...
	return render(request, 'smartzyapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'smartzyapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'smartzyapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'smartzyapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'smartzyapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'smartzyapp/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'smartzyapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('smartzyapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('smartzyapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'smartzyapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('smartzyapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'smartzyapp/account_settings.html', context)
...
def notifications(request):
	...
	return render(request, 'smartzyapp/notifications.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('smartzyapp/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('smartzyapp/debitMail.html', {'name':client_username,
	...
	context= {}
	return render(request, 'smartzyapp/transferFunds.html', context)
...
def video_page(request):
	...
	return render(request, 'smartzyapp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('smartzyapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('smartzyapp/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
	...
	return render(request, 'smartzyapp/reinvest.html', context)
...
def loan(request):
	...
	return render(request, 'smartzyapp/loan.html')
...
def portfolio2(request):
	...
	return render(request, 'smartzyapp/portfoliodash.html', context)